...
<head>
  ...
  <meta name="author" content="">
	...
	<link rel="icon" type="image/png" href="img/alumni.png">
...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-default fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand js-scroll-trigger" href="#page-top">Sisfo Alumni</a>
  ...
  <header class="masthead">
    <div class="container">
      <div class="intro-text">
        ...
        <a class="btn btn-primary btn-xl text-uppercase js-scroll-trigger" href="#portfolio">More</a>
      </div>
    </div>
  </header>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12 text-center">
          <h2 class="section-heading text-uppercase">Zona Info</h2>
          <h3 class="section-subheading text-muted">Lorem ipsum dolor sit amet consectetur.</h3>
        </div>
      </div>
      <div class="content">
      <div class="col-lg-12 text-center with-border">
        <div class="row">
        <div class="col-md-12">
      ...
      <div class="row">
        <div class="col-sm-6">
          <div class="team-member">
            ...
            <h4>Agus Padilah H</h4>
            <p class="text-muted">lead Programer</p>
